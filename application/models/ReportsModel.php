...
class ReportsModel extends CI_Model {
	...
	public function create_report($cities_id, $lost_address, $lost_date, $name, $type_pet_id, $breed, $color, $size_pet_id, $cellphone1, $cellphone2, $reward, $status_id, $users_id, $description){
		$this->load->database("findme");
		$result = $this->db->query("INSERT INTO pet_report (cities_id, lost_address, lost_date, name, type_pet_id, breed, color, size_pet_id, cellphone1, cellphone2, reward, status_id, users_id, description) values ('$cities_id', '$lost_address', '$lost_date', '$name', '$type_pet_id', '$breed', '$color', '$size_pet_id', '$cellphone1', '$cellphone2', '$reward', '$status_id', '$users_id', '$description')");
		return "ok";
	}
}
